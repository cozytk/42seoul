...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/08/15 16:25:12 by jujeong           #+#    #+#             */
/*   Updated: 2020/08/15 16:41:30 by jujeong          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	pthread_mutex_lock(&a->stat->write_lock);
	if (a->stat->dead)
		return ;
	...
	pthread_mutex_unlock(&a->stat->write_lock);
}
